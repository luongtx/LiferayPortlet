...
public class StudentPersistenceImpl extends BasePersistenceImpl<Student>
	 ...
	 */
	@Override
	public List<Student> findByC_F_G(String code, String fullName, String gender)
		throws SystemException {
	...
	public List<Student> findByC_F_G(String code, String fullName,
			...
			for (Student student : list) {
				if (!StringUtil.wildcardMatches(student.getCode(), code,
						...
						!StringUtil.wildcardMatches(student.getFullName(),
							fullName, CharPool.UNDERLINE, CharPool.PERCENT,
							CharPool.BACK_SLASH, true) ||
						!Validator.equals(gender, student.getGender())) {
					list = null;
		...
		if (list == null) {
			...
			if (gender == null) {
				query.append(_FINDER_COLUMN_C_F_G_GENDER_1);
			}
			else if (gender.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_C_F_G_GENDER_3);
			}
			else {
				bindGender = true;
	...
	public Student[] findByC_F_G_PrevAndNext(long studentId, String code,
		String fullName, String gender, OrderByComparator orderByComparator)
		throws NoSuchStudentException, SystemException {
		Student student = findByPrimaryKey(studentId);
	...
	protected Student getByC_F_G_PrevAndNext(Session session, Student student,
		String code, String fullName, String gender,
	 ...
	 */
	@Override
	public void removeByC_F_G(String code, String fullName, String gender)
		throws SystemException {
	 ...
	 */
	@Override
	public int countByC_F_G(String code, String fullName, String gender)
		throws SystemException {
	...
	private static final String _FINDER_COLUMN_C_F_G_GENDER_1 = "student.gender IS NULL";
	private static final String _FINDER_COLUMN_C_F_G_GENDER_2 = "student.gender = ?";
	private static final String _FINDER_COLUMN_C_F_G_GENDER_3 = "(student.gender IS NULL OR student.gender = '')";
